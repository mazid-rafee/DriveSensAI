...
DEFAULT_CHECKPOINT_RELATIVE = "saved_weights/best_loss.pt"
DEFAULT_HOST = "0.0.0.0"
DEFAULT_PORT = 8001
DEFAULT_DEVICE = "auto"

# Sampling rate is NOT stored in best_loss.pt and is not defined in the
# training/inference Python code. When DROWSINESS_SAMPLING_RATE_HZ is set, the
# API enforces an exact match. When unset, any finite positive rate is accepted
# and health reports sampling_rate_hz=null.
